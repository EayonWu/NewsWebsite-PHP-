...
<table cellpadding=0 cellspacing=0 width=158 align=center>
  <tr>
    <td height=25 class=menu_title onmouseover=this.className='menu_title2'; onmouseout=this.className='menu_title'; background="images/Admin_left_9.gif" id=menuTitle2 onClick="showsubmenu(1)" style="cursor:hand;"><span>系统管理</span> </td>
  </tr>
  <tr>
    <td style="display:block" id='submenu1'><div class=sec_menu style="width:158">
      <table cellpadding=0 cellspacing=0 align=center width=130>
        <tr>
...
<table cellpadding=0 cellspacing=0 width=158 align=center>
  <tr>
        <td height=25 class=menu_title onmouseover=this.className='menu_title3'; onmouseout=this.className='menu_title'; background="images/Admin_left_1.gif" id=menuTitle1 onClick="showsubmenu(2)" style="cursor:hand;"> 
          <span>新闻管理</span> </td>
  </tr>
  <tr>
...
<div class=sec_menu style="width:158">
<table cellpadding=0 cellspacing=0 align=center width=130>
<tr><td height=20><a href="add_category.php" target=main>添加分类</a></td></tr>
<tr><td height=20><a href="categorylist.php" target=main>分类管理</a></td></tr>
<tr>
  <td height=20><a href="add_arc.php" target="main">添加新闻</a></td>
</tr>
<tr>
  <td height=20><a href="manage_arc.php" target="main">管理新闻</a></td>
</tr>
...
<table cellpadding=0 cellspacing=0 width=158 align=center>
  <tr>
        <td height=25 class=menu_title onmouseover=this.className='menu_title2'; onmouseout=this.className='menu_title'; background="images/Admin_left_9.gif" id=menuTitle2 onClick="showsubmenu(7)" style="cursor:hand;"> 
          <span>用户管理</span> </td>
  </tr>
  <tr>
    <td style="display:block" id='submenu7'>
<div class=sec_menu style="width:158">
<table cellpadding=0 cellspacing=0 align=center width=130>
<tr>
<td height=20><a href="add_hy.php" target="main">添加用户</a></td></tr>
<tr>
  <td height=20><a href="hylist.php" target="main">用户管理</a></td>
</tr>
